...
bool scalar_worker_add<T1, T2>::operator() (type::value_t self, type::vector_t parameters, type::value_t return_value)
{
...
template<typename T1, typename T2>
bool
scalar_worker_sub<T1, T2>::operator() (type::value_t self, type::vector_t parameters, type::value_t return_value)
{
    auto cur = self->get<T1>();
    if (parameters.size() != 1) {
        return false;
...
template<typename T1, typename T2>
bool
scalar_worker_mul<T1, T2>::operator() (type::value_t self, type::vector_t parameters, type::value_t return_value)
{
    auto cur = self->get<T1>();
    if (parameters.size() != 1) {
        return false;
...
template<typename T1, typename T2>
bool
scalar_worker_div<T1, T2>::operator() (type::value_t self, type::vector_t parameters, type::value_t return_value)
{
    auto cur = self->get<T1>();
    if (parameters.size() != 1) {
        return false;
...
template<typename T1, typename T2>
bool
scalar_worker_mod<T1, T2>::operator() (type::value_t self, type::vector_t parameters, type::value_t return_value)
{
    auto cur = self->get<T1>();
    if (parameters.size() != 1) {
        return false;
...
template<typename T1, typename T2>
bool
scalar_worker_intdiv<T1, T2>::operator() (type::value_t self, type::vector_t parameters, type::value_t return_value)
{
    auto cur = self->get<T1>();
    if (parameters.size() != 1) {
        return false;
...
template<typename T>
bool
string_worker_offset_set<T>::operator() (type::value_t self, type::vector_t parameters, type::value_t return_value)
{
    auto cur = self->get<T>();
...
template<typename T>
bool
string_worker_offset_get<T>::operator() (type::value_t self, type::vector_t parameters, type::value_t return_value)
{
    auto cur = self->get<T>();
    if (parameters.size() != 2) {
        return false;
...
template<typename T>
bool string_worker_add<T>::operator() (type::value_t self, type::vector_t parameters, type::value_t return_value)
{
    auto cur = self->get<T>();
    if (parameters.size() > 1) {
        return false;
...
*/
    ...
    worker_binary_operator_registration(ce_integer, OP_MOD, type::worker_t(new scalar_worker_mod<long, double>()), ce_float);
    ...
    worker_binary_operator_registration(ce_float, OP_MOD, type::worker_t(new scalar_worker_mod<double, double>()), ce_float);
    ...
    worker_binary_operator_registration(ce_float, OP_MOD, type::worker_t(new scalar_worker_mod<double, long>()), ce_integer);
